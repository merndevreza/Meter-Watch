...
/**
 * Service for saving scraped data to database
...
export class CustomerDataService {
  ...
  async saveScrapedData(
    ...
    try {
      ...
      const rechargeResult = await this.saveRechargeHistory(
      ...
      const consumptionResult = await this.saveMonthlyConsumption(
  ...
  /**
   * Save recharge history using bulk operations
   * Only saves new records (prevents duplicates)
   */
  private async saveRechargeHistory(
  ...
  /**
   * Save monthly consumption using bulk operations
   * Updates existing records or creates new ones
   */
  private async saveMonthlyConsumption(
